...
class User extends ActiveRecord
{
    ...
    public function getProfile()//get+名称对应控制器中joinWith(名称)
    {
        return $this->hasOne(Profile::className(), ['userid' => 'userid']);//根据userid关联表profile,即user.userid=profile.userid
    }
    ...
    {
        $data['User']['username'] = 'test'.uniqid();
